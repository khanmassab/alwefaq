...
class PartnerRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.admin.partnerRequests.index', compact('requests'));
    }
    ...
    {
        return Datatables::of($this->marriageRequestRepository->getDatatable2())
            ->addIndexColumn()
            ->addColumn('action', function ($row) {
                $edit = '<a href="' . route('partnerRequests.edit', $row->id) . '" type="button" class="btn btn-sm btn-info">' . trans('app.show') . '</a> ';
    ...
    public function suggestedPartner()
    {
        ...
        return view('backend.admin.partnerRequests.suggested', compact('suggests','helps','request_id'));
    }
    ...
    public function addMarriageRequest()
    {
        ...
        return view('backend.admin.partnerRequests.addMarriage', compact('cities','nationalities','qualifications'));
        }
    }
    ...
    public function addPartnerRequest()
    {
        ...
        $nationalities = $this->nationalityRepository->all();
        $qualifications = $this->qualificationRepository->all();
        return view('backend.admin.partnerRequests.add-edit', compact('cities','nationalities','qualifications','edit'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.admin.partnerRequests.create-edit', compact('edit','request'));
    ...
    public function show($id)
    {
        ...
        return view('backend.admin.partnerRequests.show', compact('partner','request_id'));
    ...
    public function update(MarriageRequestUpdateRequest $request, $id)
    {
        ...
        return redirect()->route('backend.admin.partnerRequests.index')->withSuccess(trans('app.success_update'));
    }
