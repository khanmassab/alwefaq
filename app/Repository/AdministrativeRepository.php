...
class AdministrativeRepository extends BaseRepository implements AdministrativeRepositoryInterface
{
    /**
     * AdministrativeRepository constructor.
     *
     * @param Administrative $model
     */
    ...
    public function createWithUploadImage(Request $request): void
    {
        ...
        if ($files = $request->file('image')) {
            $destinationPath = 'public/uploads/administratives/'; // upload path
