                    ...
                    {{ $error }}
                        ...
                        <form action="{{ route('help.store') }}" method="POST">
                            ...
                            <p>
                                ...
                                <input type="text" class="form-control" value="{{ old('full_name') }}" name="full_name" required  />
                            </p>
                            <p>
                            ...
                            <p>
                                <label>  المبلغ</label>
                                <input type="number" step="any" min="1"  class="form-control" name="value_request"  value="{{ old('value_request') }}" required />
                            </p>
