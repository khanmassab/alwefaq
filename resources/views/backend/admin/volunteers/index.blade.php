...
@section('page-title', trans('app.volunteers'))
@section('page-heading', trans('app.volunteers'))
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#volunteersTable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: '{!! route('volunteers.getDatatable') !!}',
                columns: [
    ...
    @include('backend.partials.deleteMode',['routeName'=>'volunteers.destroy'])
@endsection
    ...
    <div class="card">
        <h6 class="card-header">
            <div class="card-title with-elements">
                <h5 class="m-0 mr-2">@lang('app.volunteers')</h5>
        ...
        <div class="card-datatable table-responsive">
            <table class="table table-striped table-bordered" id="volunteersTable">
                <thead>
                <tr>
                    <th>#</th>
                    <th>@lang('app.name')</th>
