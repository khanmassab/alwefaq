...
@if($edit)
    @section('page-title', trans('app.edit_services'))
@section('page-heading', trans('app.edit_services'))
@else
    @section('page-title', trans('app.add_services'))
@section('page-heading', trans('app.add_services'))
@endif
...
@section('content')
    @if($edit)
        {!! Form::open(['route' => ['services.update',$service->id], 'method' => 'PUT','files' => true, 'id' => 'page-form']) !!}
    @else
        {!! Form::open(['route' => 'services.store', 'files' => true, 'id' => 'page-form']) !!}
    @endif
    <div class="card mb-4">
...
{{--                        <img src="{{ $service->icon }}" alt="" class="card-img-top" style="max-height: 400px">--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            @endif--}}
{{--            <div class="form-group row">--}}
{{--                <label class="col-form-label col-sm-2 text-sm-right">@lang('app.image')</label>--}}
{{--                <input {{ $edit ? '' : 'required'}} type="file" name="icon">--}}
{{--            </div>--}}
{{--            <div class="form-group row">--}}
            ...
            <!--</div>-->
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="parent">
                        ...
                        @if($edit)
                        <option @if($service->parent == $parent->id || $parent->id == old('parent')) selected="selected" @endif value="{{ $parent->id }}">{{ $parent->title }}</option>
                            @else
