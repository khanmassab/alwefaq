...
@if($edit)
    @section('page-title', trans('app.edit_partners'))
@section('page-heading', trans('app.edit_partners'))
@else
    @section('page-title', trans('app.add_partners'))
@section('page-heading', trans('app.add_partners'))
@endif
...
@section('content')
    @if($edit)
        {!! Form::open(['route' => ['partners.update',$partner->id], 'method' => 'PUT','files' => true, 'id' => 'page-form']) !!}
    @else
        {!! Form::open(['route' => 'partners.store', 'files' => true, 'id' => 'page-form']) !!}
    @endif
    <div class="card mb-4">
        <h6 class="card-header">
            @lang('app.partner_details')
        </h6>
        <div class="card-body">
            <div class="form-group row">
                <label class="col-form-label col-sm-2 text-sm-right">@lang('app.name')</label>
                <div class="col-sm-10">
                    {!! Form::text('name',$edit ? $partner->name : old('name'),['class' => 'form-control','placeholder' => trans('app.name')]) !!}
                </div>
            </div>
            ...
            @if($edit)
                <div class="form-group row">
                    ...
                    <div class="img-thumbnail">
                        <img src="{{ $partner->image }}" alt="" class="card-img-top" style="max-height: 400px">
                    </div>
                </div>
            @endif
            <div class="form-group row">
