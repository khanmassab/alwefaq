...
@if($edit)
    @section('page-title', trans('app.partnerRequests'))
@section('page-heading', trans('app.partnerRequests'))
@else
    @section('page-title', trans('app.add_partnerRequests'))
@section('page-heading', trans('app.add_partnerRequests'))
@endif
...
@section('content')
    <div class="card mb-4">
        <h6 class="card-header">
            @lang('app.partnerRequest_details')
        </h6>
        <div class="card-body">
