...
@if($edit)
    @section('page-title', trans('app.edit_newsCategories'))
@section('page-heading', trans('app.edit_newsCategories'))
@else
    @section('page-title', trans('app.add_newsCategories'))
@section('page-heading', trans('app.add_newsCategories'))
@endif
...
@section('content')
    @if($edit)
        {!! Form::open(['route' => ['newsCategories.update',$newsCategory->id], 'method' => 'PUT','files' => true, 'id' => 'page-form']) !!}
    @else
        {!! Form::open(['route' => 'newsCategories.store', 'files' => true, 'id' => 'page-form']) !!}
    @endif
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    {!! Form::text('name',$edit ? $newsCategory->name : old('name'),['class' => 'form-control','placeholder' => trans('app.title')]) !!}
                </div>
            </div>
            ...
            @if($edit)
                <div class="form-group row">
                    ...
                    <div class="img-thumbnail">
                        <img src="{{ $newsCategory->image }}" alt="" class="card-img-top" style="max-height: 400px">
                    </div>
                </div>
            @endif
            <div class="form-group row">
