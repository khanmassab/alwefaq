...
<html lang="{{ App::getLocale() }}" class="material-style" dir="{{ App::isLocale('ar') ? 'rtl' : 'ltr' }}">
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('frontend/images/favicons/android-chrome-512x512.png') }}">
